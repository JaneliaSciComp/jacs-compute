...
import org.janelia.jacs2.asyncservice.lvtservices.KTXCreator;
import org.janelia.jacs2.asyncservice.lvtservices.OctreeCreator;
 ...
 */
@Named("workflow")
public class WorkflowExecution extends AbstractServiceProcessor<File> {
    ...
    @Inject
    WorkflowExecution(ServiceComputationFactory computationFactory,
    ...
    public ServiceMetaData getMetadata() {
        return ServiceArgs.getMetadata(WorkflowExecution.class, new LVTDataImportArgs());
    }
