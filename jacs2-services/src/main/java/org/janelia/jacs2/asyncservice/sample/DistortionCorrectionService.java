...
public class DistortionCorrectionService extends AbstractServiceProcessor<WorkflowImage> {

    static class EmptyArgs extends ServiceArgs {
    }

    @Inject
    DistortionCorrectionService(ServiceComputationFactory computationFactory,
    ...
    public ServiceMetaData getMetadata() {
        return ServiceArgs.getMetadata(DistortionCorrectionService.class, new EmptyArgs());
    }
