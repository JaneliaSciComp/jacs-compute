 ...
 */
@Named("lsmProcessing")
public class LSMProcessingService extends AbstractServiceProcessor<LSMSummaryResult> {

    static class EmptyArgs extends ServiceArgs {
    }

    @Inject
    LSMProcessingService(ServiceComputationFactory computationFactory,
    ...
    public ServiceMetaData getMetadata() {
        return ServiceArgs.getMetadata(LSMProcessingService.class, new EmptyArgs());
    }
