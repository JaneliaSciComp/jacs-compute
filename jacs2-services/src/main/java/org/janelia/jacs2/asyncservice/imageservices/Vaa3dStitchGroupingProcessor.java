...
public class Vaa3dStitchGroupingProcessor extends AbstractServiceProcessor<File> {
    ...
    public ServiceComputation<JacsServiceResult<File>> process(JacsServiceData jacsServiceData) {
        ...
        return vaa3dPluginProcessor.process(jacsServiceData)
                .thenApply(pr -> updateServiceResult(jacsServiceData, getResultHandler().collectResult(jacsServiceData)));
    }
