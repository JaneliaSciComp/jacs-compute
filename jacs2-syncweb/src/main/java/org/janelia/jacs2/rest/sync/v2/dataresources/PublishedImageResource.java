...
public class PublishedImageResource {
    ...
    public Response getImage(@ApiParam @PathParam("slideCode") String slideCode,
                             @ApiParam @PathParam("alignmentSpace") String alignmentSpace,
                             @ApiParam @PathParam("objective") String objective) {
        LOG.trace("Start getImage({}, {}, {})", slideCode, alignmentSpace, objective);
        try {
            ...
            LOG.error("Error occurred getting published image for {}, {}, {}", slideCode, alignmentSpace, objective, e);
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(new ErrorResponse("Error retrieving published image for " + slideCode + ", "
                            + alignmentSpace + ", " + objective))
                    .build();
        } finally {
            LOG.trace("Finished getImage({}, {}, {})", slideCode, alignmentSpace, objective);
        }
    }
}