...
/**
 * A {@link ClassWriter} that overrides {@link #getCommonSuperClass(String, String) } such that it uses
...
public final class SimpleClassWriter extends ClassWriter {
    ...
    /**
     * Constructs a {@link SimpleClassWriter} object. See {@link ClassWriter#ClassWriter(ClassReader, int) }.
