...
public final class TypeUtils {
     ...
     * {@link Class#isAssignableFrom(Class) } (with some caveats, explained in next paragraph), but uses a
     ...
     * if two types are equal. The main difference between SimpleVerifier's code and {@link Class#isAssignableFrom(Class) } is
